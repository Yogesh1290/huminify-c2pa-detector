        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold gradient-text">Huminify</h1>
            ...
            <nav className="hidden md:flex items-center gap-2">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white gradient-primary rounded-lg hover:shadow-lg transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/docs" className="text-sm text-slate-600 hover:text-primary-500 transition-colors">
                    API Documentation
                  </a>
                </li>
                <li>
                  <a href="https://github.com/Yogesh1290/huminify-c2pa-detector" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-600 hover:text-primary-500 transition-colors">
                    GitHub Repository
                  </a>
                </li>
                <li>
          ...
          <div className="pt-6 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} Huminify. Open source and free forever.
            </p>
